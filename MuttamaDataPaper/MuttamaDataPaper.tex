...
\codedataavailability{The majority of the code and data including the
Rmarkdown for this paper is stored on Github
https://github.com/WillemVervoort/MuttamaDataPaper However, due to the
volume of raw data, the groundwater logger data is stored in a separate
Open Science Foundation project:
https://osf.io/beuwk/} %% use this section when having data sets and software code available
