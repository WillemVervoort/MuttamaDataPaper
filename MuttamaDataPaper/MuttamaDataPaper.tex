...
\Author[1][willem.vervoort@sydney.edu.au]{R. Willem}{Vervoort}
...
\codedataavailability{https://github.com/WillemVervoort/MuttamaDataPaper} %% use this section when having data sets and software code available
