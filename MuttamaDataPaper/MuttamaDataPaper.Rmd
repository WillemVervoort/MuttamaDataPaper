...
availability:
  codedata: |
    The majority of the code including the Rmarkdown for this paper is stored on Github https://github.com/WillemVervoort/MuttamaDataPaper
    The hydrogepchemistry data is located on the University of Sydney escholaship repository
    However, due to the volume of raw data, the groundwater logger data is stored in a separate Open Science Foundation project: https://doi.org/10.17605/OSF.IO/BEUWK
authorcontribution: | 
